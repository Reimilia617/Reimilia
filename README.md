...
- Reimilia使用硬编码进去的公钥验证，不通过则拒绝访问md文件内的项目指向网址
...
5. 我打算加个检测
- 就是如果运行的是我的官方版Reimilia，则运行时会提示"您现在运行的是Reimilia官方版本，由"Github@Reimilia617"制作"

- 如果别人改了我的源代码，即使只动了一个空格打开Reimilia时都会提示"注意。您现在运行的是非官方版Reimilia，若在使用过程中出现任何问题导致电脑损坏或数据泄漏，则Reimilia原作者概不负责！"

- 只是没想好怎么实现，因为也不能用公钥验证自己
